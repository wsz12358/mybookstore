...
import {StatBookForm} from "../Components/StatBookForm";
import {AdmStatBookForm} from "../Components/AdmStatBookForm";
...
export class AdminStatBookView extends React.Component{
                ...
                <Layout>
                    ...
                    <Content>
                        <div className={"ordercontent buttons"}>
                            <Button href={"/stats/book"}> Book </Button>
                            <Button href={"/stats/user"}> User </Button>
                        </div>
...
AdminStatBookView = withMyHook(AdminStatBookView);