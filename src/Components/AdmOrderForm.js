...
import {getOrders, DeleteOrder, getOrderByUser} from "../Service/OrderService";
...
export class AdmOrderForm extends React.Component
{
    constructor(props) {
        super(props);
        this.state = {orders: []};
            ...
            <div>
                ...
                <RangePicker onChange={this.handleSelectTime}/>
                    <Table dataSource={this.state.orders}>
                        ...
                        <Column title = "Action" dataIndex = "orderId"
                                render = {(OrderId) =>
                                    (
